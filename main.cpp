...
FloatType& divide(const FloatType& ft) { return divide(*ft.value); }
FloatType& FloatType::FloatType::add(const DoubleType& dt) { return add(*dt.value); }
...
FloatType& FloatType::FloatType::add(const IntType& it) { return add(*it.value); }
